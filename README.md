...
#### An open source, mobile-friendly <a href="https://en.wikipedia.org/wiki/Digital_audio_workstation" target="_blank">digital audio workstation</a> written in MeteorJS. 
